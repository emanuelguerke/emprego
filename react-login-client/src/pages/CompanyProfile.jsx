...
export default function CompanyProfile() {
  ...
  async function handleSave(e) {
    ...
    try {
      ...
      if (!payloadToken || !payloadToken.sub) {
      ...
      const payload = {
        ...
        password: form.password, // empty => backend keeps current
        street: form.street,
        number: form.number,
        city: form.city,
        state: form.state,
  ...
  return (
    <div className="page-root">
      <div className="card" style={{ position: "relative" }}>
        {/* back arrow like in Profile.jsx */}
        <div style={{ display: "flex", alignItems: "center", marginBottom: 12 }}>
          <button
            ...
            title="Voltar para Company Home"
            aria-label="Voltar"
          >
            ←
          </button>
        ...
        {!editMode ? (
          <>
            ...
            <p><strong>Ramo:</strong> {company?.business}</p>
            <p><strong>Usuario:</strong> {company?.username}</p>
            <p><strong>Rua:</strong> {company?.street}</p>
            <p><strong>Numero:</strong> {company?.number}</p>
          ...
          <form onSubmit={handleSave}>
            ...
            <label>Senha (deixe vazio para manter atual)
